...
describe('BranchesService', () => {
  it('uses a stable unique tie-breaker for paginated branches', async () => {
    ...
    await new BranchesService(prisma).list(
      {
        userId: 'user-id',
  ...
  it('rejects a client outside the authenticated organization', async () => {
    ...
    await expect(
      new BranchesService(prisma).create(
        {
        ...
        { clientId: 'a6178dd3-aaee-47f8-9765-13e25d0e38d6', code: 'BR_A', name: 'Branch A' },
      ),
